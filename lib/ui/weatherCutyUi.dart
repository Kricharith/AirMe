...
class WeatherCutyUi extends StatefulWidget {
  final String apiKey;
  ...
  @override
  State<WeatherCutyUi> createState() => _WeatherCutyUiState();
}

class _WeatherCutyUiState extends State<WeatherCutyUi> {
...
//   }
  ...
  Future<PMdata?> getdata() async {
    var response = await http.get(Uri.parse(widget.apiKey));
